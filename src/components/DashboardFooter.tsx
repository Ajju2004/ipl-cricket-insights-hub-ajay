...
const DashboardFooter = () => {
  return (
    <div className="mt-20 text-center relative">
      <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-red-500/10 blur-2xl -z-10 rounded-full"></div>
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8">
        <h3 className="text-2xl font-bold text-white mb-4 flex items-center justify-center gap-3">
          <Trophy className="text-orange-400" size={24} />
          IPL 2025 Season Complete
        </h3>
        <p className="text-orange-300 text-lg mb-6 max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          >
            <div className="flex items-center gap-2 text-orange-200 cursor-help hover:text-white transition-colors">
              <Users size={16} />
        ...
        <Button variant="ghost" size="lg" className="mt-6 text-orange-300 hover:text-white hover:bg-white/10 transition-all duration-300">
